...
#define INGENIC_DMA_REQ_AEC     	0x5
#define INGENIC_DMA_REQ_I2S0_TX	    0x6
#define INGENIC_DMA_REQ_I2S0_RX	    0x7
#define INGENIC_DMA_REQ_AUTO_TX	    0x8
#define INGENIC_DMA_REQ_SADC_RX     0x9
#define INGENIC_DMA_REQ_DMIC_RX	    0xd
#define INGENIC_DMA_REQ_SLV_TX	    0xe
#define INGENIC_DMA_REQ_SLV_RX	    0xf
