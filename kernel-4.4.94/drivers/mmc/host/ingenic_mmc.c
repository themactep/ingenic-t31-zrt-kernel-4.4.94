...
static int __init ingenic_mmc_gpio_init(struct ingenic_mmc_host *host)
{
	...
	/* set PB 0-5 drive strength 8 */
	jzgpio_set_func(GPIO_PORT_B, GPIO_DRIVE_STRENGTH_8, 0);
	jzgpio_set_func(GPIO_PORT_B, GPIO_DRIVE_STRENGTH_8, 1);
	jzgpio_set_func(GPIO_PORT_B, GPIO_DRIVE_STRENGTH_8, 2);
	jzgpio_set_func(GPIO_PORT_B, GPIO_DRIVE_STRENGTH_8, 3);
	jzgpio_set_func(GPIO_PORT_B, GPIO_DRIVE_STRENGTH_8, 4);
	jzgpio_set_func(GPIO_PORT_B, GPIO_DRIVE_STRENGTH_8, 5);
