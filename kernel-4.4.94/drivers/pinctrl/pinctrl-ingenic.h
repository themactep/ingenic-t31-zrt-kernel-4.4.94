...
#define PxPIE		0x180   /* Port Receiver Enable State Register */
#define PxPIES		0x184   /* Port Receiver Enable State Set Register */
#define PxPIEC		0x188   /* Port Receiver Enable State Clear Register */
